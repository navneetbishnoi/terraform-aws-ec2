...
##=====================================================================================
module "vpc" {
  source      = "git::https://github.com/navneetbishnoi/terraform-aws-vpc.git?ref=v1.0.4"
  name        = "app"
...
module "public_subnets" {
  source             = "git::https://github.com/navneetbishnoi/terraform-aws-subnet.git?ref=v1.0.4"
  name               = "public-subnet"
  environment        = local.environment
  label_order        = local.label_order
