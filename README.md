...
## Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/navneetbishnoi/terraform-aws-ec2/tree/main/_example) directory within this repository.
